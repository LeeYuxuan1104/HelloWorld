...
public class MainActivity extends Activity implements OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> arg0, View view, int position,
		...
		try {
			Toast.makeText(MainActivity.this, "selectDevice:" +selectDevice,Toast.LENGTH_SHORT).show();
			// 判断客户端接口是否为空
			if (clientSocket == null) {
				...
				Toast.makeText(MainActivity.this, "selectDevice:"+selectDevice+"\r\nclientSocket:"+clientSocket, Toast.LENGTH_SHORT).show();
				// 获取到输出流，向外写数据
